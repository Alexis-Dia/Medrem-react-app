...
const _SvgIcon = require("material-ui-old-core/SvgIcon");
...
const CheckIcon = function CheckIcon(props) {
...
const WarningIcon = function WarningIcon(props) {
    return _react2.default.createElement(
        _SvgIcon2.default,
        props,
...
const ErrorIcon = function ErrorIcon(props) {
    return _react2.default.createElement(
        _SvgIcon2.default,
        props,
...
const allClasses = exports.allClasses = {
    mui: {
        root: {},
...
const defaultIconVariant = exports.defaultIconVariant = {
...
const SNACKBAR_INDENTS = exports.SNACKBAR_INDENTS = {
    view: { default: 20, dense: 4 },
    snackbar: { default: 6, dense: 2 },
};

const capitalise = exports.capitalise = function capitalise(text) {
    return text.charAt(0).toUpperCase() + text.slice(1);
};

const originKeyExtractor = exports.originKeyExtractor = function originKeyExtractor(anchor) {
