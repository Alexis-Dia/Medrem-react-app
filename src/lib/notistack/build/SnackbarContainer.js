...
const _classnames = require("../../../routes/loginView/textFieldGroup/node_modules/classnames");
...
const SnackbarContainer = _react2.default.memo((props) => {
    let { classes } = props,
        { className } = props,
        { anchorOrigin } = props,
        { dense } = props,
    ...
    const combinedClassname = (0, _classnames2.default)(classes.root, classes[anchorOrigin.vertical], classes[anchorOrigin.horizontal], classes[`${anchorOrigin.vertical}${dense ? "Dense" : ""}`], classes[`${anchorOrigin.horizontal}${dense ? "Dense" : ""}`], _defineProperty({}, classes.reverseColumns, anchorOrigin.vertical === "bottom"), className);

    return _react2.default.createElement("div", { className: combinedClassname, ...other });
});
